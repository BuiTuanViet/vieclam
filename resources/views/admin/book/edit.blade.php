...
@section('content')
    ...
    <section class="content">
        <div class="row">
            <!-- form start -->
            <form role="form" action="{{ route('book.update', ['contact_id' => $book->book_id]) }}" method="POST" enctype="multipart/form-data">
                {!! csrf_field() !!}
                {{ method_field('PUT') }}
                    ...
                    <div class="box box-primary">
                        ...
                        <div class="box-body">
                            ...
                            <div class="form-group">
                                ...
                                <input type="number" class="form-control" name="number" placeholder="Số lượng" value="{{ $book->number }}" required>
                            </div>

                            <div class="form-group">
                                <label for="exampleInputEmail1">Đặt cọc</label>
                                <input type="number" class="form-control" name="prepay" placeholder="Đặt cọc" value="{{ $book->prepay }}" required>
                            </div>
