                                            ...
                                            <div class="col-xs-12 col-md-5">
                                                ...
                                                <div class="box box-primary">
                                                    <div class="box-body">
                                                        ...
                                                        <div class="form-group">
                                                            <label for="exampleInputEmail1">Mã sản phẩm {{ $language->language }}</label>
                                                            <input type="text" class="form-control" name="code[]" placeholder="Mã sản phẩm" value="{{ $postLanguage['product']->code }}" />
                                                        </div>

                                                        <div class="form-group">
                                                            <label for="exampleInputEmail1">Thuộc tính sản phẩm {{ $language->language }}</label>
                                                            <textarea class="form-control" rows="4" name="properties[]" placeholder="Điền thuộc tính sản phẩm (màu sắc, kích cỡ, ...)" >{{ $postLanguage['product']->properties }}</textarea>
                                                        </div>

                                                        <div class="form-group">
                                                            <label for="exampleInputEmail1">Giá {{ $language->language }}</label>
                                                            <input type="text" class="form-control" name="price[]" placeholder="Giá sản phẩm"  value="{{ $postLanguage['product']->price }}"/>
                                                        </div>
...
{{--                                                                   size="20"/>--}}
                                                            ...
                                                            <input name="image_list[]" type="hidden" value="{{ $postLanguage['product']->image_list }}"/>
                                                        </div>
